...
final class RemoveObstructiveServices implements CompilerPassInterface
{
    private const REMOVE_DEFINITIONS = [
        ...
        \Shopware\Core\Framework\DataAbstractionLayer\FieldSerializer\PasswordFieldSerializer::class,
        \Shopware\Core\Framework\DataAbstractionLayer\FieldSerializer\RemoteAddressFieldSerializer::class,
        ...
        \Shopware\Core\Framework\Routing\RouteScopeListener::class,
        ...
        \Shopware\Core\Framework\Store\Services\ShopSecretInvalidMiddleware::class,
        \Shopware\Core\Framework\Store\Services\StoreClient::class,
        \Shopware\Core\Framework\Store\Services\StoreClientFactory::class,
        \Shopware\Core\Framework\Store\Services\StoreService::class,
        \Shopware\Core\Framework\Store\Subscriber\LicenseHostChangedSubscriber::class,
